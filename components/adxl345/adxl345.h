...
#define ADXL345_INACT_ACDC \
    (1 << 3)  ///< AC/DC coupling for inactivity (0=DC, 1=AC)
 ...
 *
 * @param threshold The activity detection threshold (unsigned 8-bit value,
 * scale factor 62.5 mg/LSB).
 * @param int_pin The physical interrupt pin (INT1 or INT2) to map the interrupt
 * to.
 ...
 *
 * @param threshold The inactivity detection threshold (unsigned 8-bit value,
 * scale factor 62.5 mg/LSB).
